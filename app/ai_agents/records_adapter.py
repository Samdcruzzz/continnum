...
Each record dict looks like one of:
  {"type": "diagnosis"/"procedure", "category": "...", "date": "...",
   "condition": "...", "source": "...", "record_id": ...}
  {"type": "lab"/"vitals", "category": "...", "date": "...",
   "value": "...", "source": "...", "record_id": ...}
  {"type": "medication", "category": "...", "date": "...",
   "medicine_name": "...", "dose": "...", "change_note": "...", 
   "source": "...", "record_id": ...}
  {"type": "observation", "category": "...", "date": "...",
   "value": "...", "caregiver_name": "...", "severity": "...", "record_id": ...}

Categories are normalized to lowercase so they compare cleanly against
Consent.allowed_categories (also normalized to lowercase at read time).
"""
